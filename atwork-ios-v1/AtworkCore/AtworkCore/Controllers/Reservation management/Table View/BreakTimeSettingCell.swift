//
//  BreakTimeSettingCell.swift
//  AtworkCore
//
//  Created by Trần Tiến Anh on 11/19/18.
//  Copyright © 2018 Atwork. All rights reserved.
//

import UIKit
protocol BreakTimeSettingCellDelegate  {
    func tapContentFromTo(isFrom: Bool, tag: Int)
}
class BreakTimeSettingCell: UITableViewCell {
    ...
    var delegate:BreakTimeSettingCellDelegate?
    var tagView: Int!
    ...
    func setActive(isActive: Bool){
        ...
        btnDelete.isUserInteractionEnabled = isActive
    }
