...
class LWViewInputBase: UIView {
    ...
    func initSubview() {
        ...
        self.labTitle.backgroundColor = AT_COLOR_TITLE_INPUT_PERFORMACE
        self.labTitle.layer.borderWidth = 1
        self.labTitle.layer.borderColor = AT_COLOR_BORDER.cgColor
        self.labTitle.font = UIFont.systemFont(ofSize: AT_FONT_SIZE_NORMAL)
        self.textFieldContent.font = UIFont.systemFont(ofSize: AT_FONT_SIZE_NORMAL)
