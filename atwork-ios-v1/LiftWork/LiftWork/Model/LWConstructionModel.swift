...
class LWConstructionModel: LWBaseModel {
    ...
    var carryArchitect:[LWContructionCarryModel]?
     var carryEquipment:[LWContructionCarryModel]?
...
//    }
    override func mapping(map: Map) {
        ...
        self.carryArchitect <- map["carryArchitect"]
         self.carryEquipment <- map["carryEquipment"]
