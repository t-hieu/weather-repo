...
//Hieu
protocol LWLiftMaterialSelectViewControllerDelegate3 {
    func liftMaterialSelectTap(liftMaterial: LWGoodModel?, unitQuantity: String,NameOfTypeisSelected : String)
}
//End
class LWLiftMaterialSelectViewController2: UIViewController, UITableViewDelegate, UITableViewDataSource, LWLiftMaterialtCellDelegate, LWViewOneLabelDelegate, KeyboardDelegate {
...
//    var TypeIsSelected = [true,false,false,false]
    var delegate: LWLiftMaterialSelectViewControllerDelegate3?
