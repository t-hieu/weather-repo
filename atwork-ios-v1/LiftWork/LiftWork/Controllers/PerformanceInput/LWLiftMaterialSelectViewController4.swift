...
//Hieu
protocol LWLiftMaterialSelectViewControllerDelegate5 {
...
//End
class LWLiftMaterialSelectViewController4: UIViewController, UITableViewDelegate, UITableViewDataSource, LWLiftMaterialtCellDelegate, LWViewOneLabelDelegate, KeyboardDelegate {
...
//    var TypeIsSelected = [true,false,false,false]
    var delegate: LWLiftMaterialSelectViewControllerDelegate5?
...
//        delegate?.liftMaterialSelectTap(liftMaterial: LWGoodModel(), unitQuantity: self.unitView.contentTextField.text!, NameOfTypeisSelected: NameOfTypeIsSelected(TypeIsSelected: CarryInTypeView.CarryInTypeIsEnable) , TypeisSelected: CarryInTypeView.CarryInTypeIsEnable)
    }
...
//    }
    ...
    func tapViewOneLabelInTitle(view: LWViewOneLabel) {
        //delegate?.liftMaterialSelectTap(liftMaterial: nil,  unitQuantity: self.unitView.contentTextField.text!, NameOfTypeisSelected: CarryInTypeView.getLabelChoice())
        checkMaterialSelected(selectedMaterials: selectedMaterials)
        
        delegate?.liftMaterialSelectTap4(liftMaterials: self.selectedMaterials,  unitQuantity: self.unitView.contentTextField.text!, NameOfTypeisSelected: CarryInTypeView.getLabelChoice())
