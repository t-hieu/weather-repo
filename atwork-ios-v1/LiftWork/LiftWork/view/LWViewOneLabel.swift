...
//        contentView.frame = bounds
        ...
        contentView.backgroundColor = LW_COLOR_BLUE_LIGHT
        self.labTitle.font = UIFont.boldSystemFont(ofSize: LW_FONT_SIZE_BIG)
        self.labTime.font = UIFont.boldSystemFont(ofSize: LW_FONT_SIZE_NORMAL)
