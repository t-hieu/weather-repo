...
class LWTabbarViewController: UITabBarController,MainStoryboard, ATMonthlyControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 11.0, *) {
            self.view.addConstraint(NSLayoutConstraint.init(item: customTabbar, attribute: NSLayoutAttribute.bottom, relatedBy: NSLayoutRelation.equal, toItem: self.view.safeAreaLayoutGuide, attribute: NSLayoutAttribute.bottom, multiplier: 1, constant: 0))
        } else {
...
//        let vc2 = DailyController.createInstanceFromStoryboard()!
        ...
        //tab 3
        let vc3 = ATBasicViewController.init(nibName: ATBasicViewController.className, bundle: Bundle.init(for: ATBasicViewController.self))
