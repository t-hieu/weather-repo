...
//  TrenteCoreSwift
//
//  Created by TrungND on 8/25/17.
//  Copyright © 2017 Trente. All rights reserved.
//

import UIKit

@objc public protocol TRMonthPickerViewDelegate {
    func doneMonthPickerView(pickerView: TRMonthView)
    @objc optional func cancelMonthPickerView(pickerView: TRMonthView)
}

public class TRMonthView: UIView {
    
    var keyWindow: UIWindow?
    public var datePicker: TRMonthPickerView?
    var toolBar: UIToolbar?
    
    public var delegate: TRMonthPickerViewDelegate?
    var date: Date?
    ...
    func addDatePicker() {
        self.datePicker = TRMonthPickerView.init()
